          ...
          <div className="p-3 border-t border-ios-separator/30">
            <div className="flex items-center gap-3 px-3 py-2.5 rounded-ios bg-ios-fill mb-1">
              ...
              <div className="flex-1 min-w-0">
                ...
                <span className={`text-caption2 font-semibold px-1.5 py-0.5 rounded-full ${profile?.role==='admin'?'bg-purple-100 text-ios-purple':profile?.role==='manager'?'bg-blue-100 text-ios-blue':'bg-ios-fill2 text-ios-secondary'}`}>{roleInfo.label}</span>
              </div>
            </div>
